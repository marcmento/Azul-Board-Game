#ifndef COSC_ASSIGN_ADV_SIX
#define COSC_ASSIGN_ADV_SIX
...
class ADVSIX {
public:
    ADVSIX(std::string p1, std::string p2, bool random_choice, std::string seed);
    ADVSIX(Player* p1, Player* p2, BST* factory1, BST* factory2, BST* factory3,
